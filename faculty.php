		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa fa-plus"></i> New Lecturer
				</a></span>
					</div>
					<div class="card-body">
...
<script>
	...
	$('#new_faculty').click(function(){
		uni_modal("New lecturer","manage_faculty.php","mid-large")
		
	})

	$('.view_payment').click(function(){
		uni_modal("lecturers Payments","view_payment.php?id="+$(this).attr('data-id'),"large")
		
	})
	$('.edit_faculty').click(function(){
		uni_modal("Manage lecturer Details","manage_faculty.php?id="+$(this).attr('data-id'),"mid-large")
		
	})
	$('.delete_faculty').click(function(){
		_conf("Are you sure to delete this lecturer?","delete_faculty",[$(this).attr('data-id')])
	})
